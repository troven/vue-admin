...
describe('Utils:validate', () => {
  ...
  it('validURL', () => {
    expect(validURL('https://github.com/troven/vue-admin')).toBe(true)
    expect(validURL('http://github.com/troven/vue-admin')).toBe(true)
    expect(validURL('github.com/troven/vue-admin')).toBe(false)
  })
  it('validLowerCase', () => {
